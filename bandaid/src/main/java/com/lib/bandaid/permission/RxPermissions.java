...
public class RxPermissions {
    ...
    public RxPermissions(@NonNull Context context) {
        if (context instanceof Activity) {
            mRxPermissionsFragment = getRxPermissionsFragment((Activity) context);
        } else {
            new RuntimeException("context not instanceof Activity");
        }
    }
