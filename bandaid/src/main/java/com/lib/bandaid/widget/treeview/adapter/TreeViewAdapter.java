...
package com.lib.bandaid.widget.treeview.adapter;
...
public class TreeViewAdapter extends RecyclerView.Adapter {
    ...
    public TreeViewAdapter(Context context, TreeNode root, @NonNull BaseNodeViewFactory baseNodeViewFactory) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (childrenNodes == null || childrenNodes.size() == 0) {
            ImageView imageView = nodeView.findViewById(viewBinder.getArrayIconViewId());
            ...
            if (view != null && view instanceof CheckBox) {
                ...
                checkableView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (iTreeViewNodeListening != null) {
                            iTreeViewNodeListening.nodeCheckListening(checked, treeNode);
                        }
                    }
                });
            } else {
