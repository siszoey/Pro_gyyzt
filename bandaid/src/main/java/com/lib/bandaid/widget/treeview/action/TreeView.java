...
package com.lib.bandaid.widget.treeview.action;
...
import com.lib.bandaid.widget.treeview.adapter.TreeViewAdapter;
import com.lib.bandaid.widget.treeview.adapter.i.ITreeViewNodeListening;
import com.lib.bandaid.widget.treeview.animator.TreeItemAnimator;
import com.lib.bandaid.widget.treeview.base.BaseNodeViewFactory;
import com.lib.bandaid.widget.treeview.base.SelectableTreeAction;
import com.lib.bandaid.widget.treeview.bean.TreeNode;
import com.lib.bandaid.widget.treeview.utils.TreeHelper;
...
public class TreeView implements SelectableTreeAction {
    ...
    private ITreeViewNodeListening iTreeViewNodeListening;
    ...
    public void setITreeViewNodeListening(ITreeViewNodeListening iTreeViewNodeListening) {
        this.iTreeViewNodeListening = iTreeViewNodeListening;
    }
    ...
    private RecyclerView buildRootView() {
        ...
        adapter.setITreeViewNodeListening(iTreeViewNodeListening);
    ...
    public void reMoveUnRootNode() {
        List<TreeNode> treeNodes = getAllNodes();
