 ...
 */
public class RootStatusView extends FrameLayout {

    private static final String TAG = "RootStatusView";
    ...
    public RootStatusView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RootStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RootStatusView, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(R.styleable.RootStatusView_emptyView, R.layout.status_view_empty);
        mErrorViewResId = a.getResourceId(R.styleable.RootStatusView_errorView, R.layout.status_view_error);
        mLoadingViewResId = a.getResourceId(R.styleable.RootStatusView_loadingView, R.layout.status_view_load);
        mNoNetworkViewResId = a.getResourceId(R.styleable.RootStatusView_noNetworkView, R.layout.status_view_nonet);
        mContentViewResId = a.getResourceId(R.styleable.RootStatusView_contentView, NULL_RESOURCE_ID);
        a.recycle();
