...
import com.lib.bandaid.widget.snackbar.enums.SnackbarType;
import com.lib.bandaid.widget.snackbar.layouts.SnackbarLayout;
import com.lib.bandaid.widget.snackbar.listeners.ActionClickListener;
import com.lib.bandaid.widget.snackbar.listeners.ActionSwipeListener;
import com.lib.bandaid.widget.snackbar.listeners.EventListener;
import com.lib.bandaid.widget.snackbar.listeners.SwipeDismissTouchListener;
...
public class Snackbar extends SnackbarLayout {
    ...
    public Snackbar leftIcon(@DrawableRes int leftIconId) {
    ...
    private void setLeftIconId() {
        if (leftIconId == 0) return;
        try {
            Drawable drawableLeft = getResources().getDrawable(leftIconId);
            snackbarText.setCompoundDrawablesWithIntrinsicBounds(drawableLeft, null, null, null);
            snackbarText.setCompoundDrawablePadding(2);
        } catch (Exception e) {
     ...
     *
     * @param position A {@link Snackbar.SnackbarPosition}
    ...
    private ViewGroup.MarginLayoutParams init(Context context, Activity targetActivity, ViewGroup parent, boolean usePhoneLayout) {
        SnackbarLayout layout = (SnackbarLayout) LayoutInflater.from(context)
                .inflate(R.layout.widget_snackbar_template, this, true);
        ...
        if (mUsePhoneLayout) {
            ...
            layout.setBackgroundResource(R.drawable.widget_snackbar_bg);
            ...
            if (mLineColor != null) {
                divider.setBackgroundResource(R.drawable.widget_snackbar_divider_bg);
        ...
        snackbarText = layout.findViewById(R.id.sb__text);
        snackbarText.setText(mText);
     ...
     * you know if {@link ActionClickListener#onActionClicked(Snackbar)}
     * was called. This is useful, for instance, if you want to know during
     * {@link EventListener#onDismiss(Snackbar)} if the
     * {@link Snackbar} is being dismissed because of its action click
     */
    ...
    /**
     * @return the pixel offset of this {@link Snackbar} from the left and
    ...
    /**
     * @return true if this {@link Snackbar} is currently showing
     */
    ...
    /**
     * @return true if this {@link Snackbar} is dismissing.
     */
    ...
    /**
     * @return false if this {@link Snackbar} has been dismissed
     */
     ...
     * @return the animation resource used by this {@link Snackbar} instance
     * to enter the view
     */
    @AnimRes
