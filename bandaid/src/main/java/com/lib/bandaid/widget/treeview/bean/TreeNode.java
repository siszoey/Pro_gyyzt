...
package com.lib.bandaid.widget.treeview.bean;
...
public class TreeNode {
    ...
    public static TreeNode level(int level) {
        TreeNode treeNode = new TreeNode(null);
    ...
    public void removeAllChild(TreeNode treeNode) {
        if (treeNode == null || getChildren().size() < 1) {
            return;
        }
        if (getChildren().indexOf(treeNode) != -1) {
    ...
    public TreeNode setItemClickEnable(boolean itemClickEnable) {
